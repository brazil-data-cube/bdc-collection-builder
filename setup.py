...
install_requires = [
    ...
    'bdc-collectors @ git+https://github.com/brazil-data-cube/bdc-collectors.git@b-0.8#egg=bdc-collectors',
    'bdc-catalog @ git+https://github.com/brazil-data-cube/bdc-catalog.git@v1.0.0-alpha3#egg=bdc-catalog',
